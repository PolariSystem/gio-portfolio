...
function LetsTalkButton({ className, property1 = "Press" }: LetsTalkButtonProps) {
  return (
    <div className={className || "bg-[rgba(255,255,255,0.04)] relative"}>
      <div aria-hidden className="absolute border-2 border-dashed border-white inset-0 pointer-events-none" />
...
export default function LetsTalkButton1() {
  return <LetsTalkButton className="bg-[rgba(255,255,255,0.04)] relative size-full" />;
}